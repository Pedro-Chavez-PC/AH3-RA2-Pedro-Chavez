...
public class CrearVendedor extends javax.swing.JFrame {
    ...
    private void btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActionPerformed
        if (cod.getText().equals("") || nom.getText().equals("") || caj.getText().equals("") || ven.getText().equals("") || gen.getText().equals("") || pas.getText().equals("")){
            JOptionPane.showMessageDialog(null, "No tienen que haber espacios vacios.");
        } else {
            listaVendedores.add(new POO_CrearVendedores(Integer.parseInt(cod.getText()), nom.getText(), Integer.parseInt(caj.getText()), Integer.parseInt(ven.getText()), gen.getText(), pas.getText()));
